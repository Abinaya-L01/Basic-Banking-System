...
<body>
   <div align="right">
     <b><input type="button" class="btn" onclick="location.href='Main_Bk.html';" value="Home"/><b>
   </div>
     <div class="login">
    <h2>Contact Us</h2>
...
<div>
  ...
  <div class="first"> 
    ...
    <input type="text" id="name" placeholder="Name - ex:Ajay" name="name" style="font-size:12pt;height:40px;width:350px;"><br><br>
